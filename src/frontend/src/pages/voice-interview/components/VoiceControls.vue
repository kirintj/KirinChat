...
.voice-controls { display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 16px; border-top: 1px solid var(--color-border, #e5e5e5); }
.phase-indicator { font-size: 14px; font-weight: 600; color: var(--color-primary); }
.buttons { display: flex; gap: 10px; flex-wrap: wrap; justify-content: center; }
.ctrl-btn {
  padding: 8px 20px; border-radius: 20px; border: 1px solid var(--color-border, #ddd); background: white; cursor: pointer; font-size: 13px; transition: all 0.2s;
...
.phase-btn { padding: 6px 16px; border-radius: 16px; border: 1px dashed var(--color-primary); background: transparent; color: var(--color-primary); cursor: pointer; font-size: 12px; }
</style>
