...
KirinChat 核心架构是整个系统的基础框架，提供了智能代理、模型管理、回调处理等核心功能。本文档详细介绍了核心架构的设计理念、组件功能和使用方法，为开发者和系统集成商提供全面的技术参考。
...
KirinChat 提供了多种类型的智能代理，每种代理都针对特定的使用场景进行了优化：
...
KirinChat 核心架构通过模块化设计、异步优先、流式处理和可扩展性等设计原则，构建了一个功能强大、性能优异的智能对话系统基础框架。
