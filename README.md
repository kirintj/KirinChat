...
<p align="center">
  <a href="docs/reference/kirinchat.md">技术文档</a> •
  <a href="DEV_GUIDE.md">开发指南</a> •
...
基于 [AgentChat](https://github.com/Shy2593666979/AgentChat) 项目 fork，完成全面品牌重塑：
- 项目名称 AgentChat → **KirinChat** / 麒麟智聊
- Python 包名 `agentchat` → `kirinchat`，Docker 容器名统一更新
- 清除原作者 API 密钥和个人信息
- 前后端品牌显示全面更新
...
### 1. 支持 MinIO 本地对象存储
现在支持 OSS 和 MinIO 两种对象存储方式，参考文档: [本地安装 MinIO](docs/development/install_minio_win.md)，感谢提供 Issue 的朋友:
- @xiaoyan011016
- @shenmi888
...
- 前端: Vue 3.4+, Pinia, Vite 5, TypeScript.
- 部署: Docker, Docker Compose, uv, npm.
...
## 八、文档
  ...
  - API文档: [KirinChat 技术文档](docs/reference/kirinchat.md)
  - 开发指南: [DEV_GUIDE.md](DEV_GUIDE.md)
  - 快速参考: [QUICKSTART.md](QUICKSTART.md)
  - Swagger: 启动后端后访问 /docs 查看。
